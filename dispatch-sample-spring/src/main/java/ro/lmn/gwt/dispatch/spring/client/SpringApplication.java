package ro.lmn.gwt.dispatch.spring.client;

import net.customware.gwt.dispatch.client.DefaultExceptionHandler;
import net.customware.gwt.dispatch.client.DispatchAsync;
import net.customware.gwt.dispatch.client.standard.StandardDispatchAsync;
import ro.lmn.gwt.dispatch.spring.shared.IncrementCounter;
import ro.lmn.gwt.dispatch.spring.shared.IncrementCounterResult;
 ...
 */
public class SpringApplication implements EntryPoint {
